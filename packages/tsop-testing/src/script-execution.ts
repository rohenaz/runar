/**
 * ScriptExecutionContract — compile TSOP contracts with baked constructor args
...
import type { CompileResult, CompileOptions } from 'tsop-compiler';
...
export class ScriptExecutionContract {
  ...
  private constructor(artifact: TSOPArtifact, scriptHex: string) {
    this.artifact = artifact;
    this.scriptHex = scriptHex;
  }

  /**
   * Compile a TSOP contract source with baked constructor args and return a
  ...
  static fromSource(
    ...
    const { compile } = require('tsop-compiler') as {
